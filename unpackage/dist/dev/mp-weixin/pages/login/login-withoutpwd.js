...
const uni_modules_uniIdPages_config = require("../../uni_modules/uni-id-pages/config.js");
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    g: common_vendor.sr("agreements", "36742c59-0"),
    h: common_vendor.p({
      scope: "register"
    })
  }) : {
    ...
    m: common_vendor.sr("agreements", "36742c59-2"),
    n: common_vendor.p({
      scope: "register"
    }),
    o: common_vendor.o((...args) => $options.toSmsPage && $options.toSmsPage(...args))
  }, {
    p: common_vendor.sr("uniFabLogin", "36742c59-3")
  });
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-36742c59"]]);
